...
export default function PageNotFound() {
  return (
    <div className="dark:bg-raisin-black grid min-h-screen">
      <p className="text-jet dark:bg-outer-space mx-auto my-auto mt-20 flex w-full max-w-6xl flex-col place-items-center gap-6 rounded-3xl bg-gray-100 p-6 dark:text-gray-100 lg:p-10 xl:p-16">
        <h1>404</h1>
